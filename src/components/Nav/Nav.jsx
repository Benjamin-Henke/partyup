      ...
      <div>
        ...
        {user.id && (
          <>
            ...
            <Link className="navLink" to="/info">
              <svg xmlns="http://www.w3.org/2000/svg" width="30" height="25" fill="currentColor" class="bi bi-diagram-3-fill" viewBox="0 0 16 16">
            ...
            <Link className="navLink" to="/info">
              <svg xmlns="http://www.w3.org/2000/svg" width="30" height="25" fill="currentColor" class="bi bi-file-person-fill" viewBox="0 0 16 16">
